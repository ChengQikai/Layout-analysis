...
from SeparatorHelperMethods import fit_separators_into_segmentation_mask
...
class DocumentAnalyzer:
    ...
    def get_document_paragraphs(self, document_path, line_coords=None, plot_progress=False):
        ...
        if line_coords is not None:
            segmentation_mask = fit_separators_into_segmentation_mask(segmentation_mask, line_coords)
    ...
    @staticmethod
    def dbscan_clustering(segmentation_mask):
        dbscan = DBSCAN()
